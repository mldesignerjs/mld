                ...
                {engraveFonts.map((font, key) => (
                    <div key={key} style={font.style} className="w-auto flex items-center justify-center pr-6 pb-4">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage: `url(${
                                    umbrellaSize === '30' && kindWood === 'cn'
                                        ? 'can-cn'
                                        : umbrellaSize === '30' && kindWood === 'tm'
                                        ? 'g30-trac'
                                        : umbrellaSize === '27' && kindWood === 'cn'
                                        ? 'g27-cn'
                                        : umbrellaSize === '27' && kindWood === 'tm'
                                        ? 'g27-trac'
                                        : 'chagoi-den'
                                }.jpg)`,
                        ...
                        >
                            <span
                                className={`engrave flex items-center justify-center whitespace-nowrap overflow-hidden text-center leading-normal ml-[3cm] h-[15mm] ${
                                    umbrellaSize === '23' ? 'w-[8cm]' : 'w-[12cm]'
                                } ${kindWood === 'cn' ? 'cn' : 'tm'}`}
                                style={{
